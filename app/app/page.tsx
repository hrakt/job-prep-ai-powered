import { ArrowRightIcon, Car, Loader2Icon, PlusIcon } from "lucide-react";
...
function NoJobInfos() {
    return <div className="container my-4 max-w-5xl">
        ...
        <p className="text-muted-foreground mb-8">
            To get started, enter information about the type of job you are wanting to apply for. This can be specific information copied directly from a
